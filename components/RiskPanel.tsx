    ...
    <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="p-3 bg-white/5 rounded-xl border border-white/5">
            <div className="flex justify-between items-center mb-1">
              <div className="text-[10px] text-slate-400 font-bold uppercase">Live Audio</div>
            ...
            <div className="flex items-end justify-between h-3 gap-0.5">
              {[...Array(10)].map((_, i) => (
                <div
                  key={i}
                  className={`w-1 rounded-sm transition-all duration-100 ${(i * 10) < metrics.audioLevel
      ...
      <div className="glass p-6 rounded-2xl border border-cyan-500/20 flex flex-col overflow-hidden">
        ...
        <button
          ...
          className={`w-full py-4 rounded-xl text-xs font-bold uppercase tracking-widest transition-all relative overflow-hidden group ${isAnalyzing
